...
order UNITID NAME CITY STABBR CC1987 CC1994 CC2000 BASIC2000 BASIC2010 BASIC2015

save "${LOOKUPS}/CC_FULL.dta", replace

// Long version - to merge to full data s et
use "${LOOKUPS}/CC_FULL.dta", clear
keep UNITID NAME CITY STABBR CC1987 CC1994 CC2000 BASIC2000 BASIC2010 BASIC2015 R1_* R2_* D1_* D2_*
...
// Different campuses with same instcod can have different ratings, so take max value in a year
